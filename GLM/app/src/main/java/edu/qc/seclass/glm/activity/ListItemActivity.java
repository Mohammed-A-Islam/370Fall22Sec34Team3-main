...
import edu.qc.seclass.glm.adapter.ListItemAdapter;
import edu.qc.seclass.glm.model.ListItem;
...
public class ListItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listRenameValue.setText(MainActivity.groceryList.getGroceryList(selectedGroceryListId).getName());
    ...
    private class AddNewItemListener implements View.OnClickListener {
        @Override
        public void onClick(View v) {
            Intent intent = new Intent(ListItemActivity.this, edu.qc.seclass.glm.activity.ItemActivity.class);
